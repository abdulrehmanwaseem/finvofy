    ...
    <div className="space-y-8">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">0</div>
            <p className="text-xs text-muted-foreground">0% payment rate</p>
          </CardContent>
        </Card>
        ...
        <CardContent className="space-y-4">
          <div className="flex items-start gap-4 p-4 rounded-lg border border-border bg-muted/50">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-muted-foreground">
                Start by adding customer information to create invoices faster.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4 p-4 rounded-lg border border-border bg-muted/50">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-muted-foreground">
                Accept payments directly and automate follow-ups for overdue
                invoices.
              </p>
            </div>
          </div>
